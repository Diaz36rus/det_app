...
const List<PatchRelease> kPatchNotes = [
  PatchRelease(
    ...
    version: '1.0.1',
    items: [
      'Баг-репорты уходят на сервер — видно в облаке (вкладка «Сервер» у владельца)',
      'Если сети нет — сохраняется на устройстве и отправится позже',
    ],
  ),
  PatchRelease(
    build: 97,
    version: '1.0.1',
    items: [
      'Обучение: тексты простым языком, справочники по всем разделам',
      'Отдельно: телефон, роли/мастер, календарь, касса, склад…',
      'Исправлено: случайный проскок шага и «моргание» подсветки',
    ],
  ),
  PatchRelease(
    build: 96,
    version: '1.0.1',
    items: [
      'Обучение: справочники «Меню», «Доска», «Карточка заказа» — подробный разбор кнопок',
      'Сценарии «создать заказ» / «касса» остались ниже — практика по желанию',
    ],
  ),
  PatchRelease(
    build: 95,
    version: '1.0.1',
    items: [
      'Splash при запуске: логотип Det App с лёгкой анимацией',
      'Тёмный native splash на Android без белой вспышки',
    ],
  ),
  PatchRelease(
    build: 94,
    version: '1.0.1',
    items: [
      'ЗП по цеху в карточке заказа: одна сумма на блок работ',
      'Касса: начислено / выплачено / к выплате по мастеру за месяц',
    ],
  ),
  PatchRelease(
    build: 93,
    version: '1.0.1',
    items: [
      'Склад: убрано супер-дублирование сида в облаке',
      'Автоочистка дублей позиций при открытии склада',
    ],
  ),
  PatchRelease(
    build: 91,
  ...
  PatchRelease(
    ...
    version: '1.0.1',
    items: [
      'Связь: название студии, понятные 2 способа добавить сотрудника, автообновление назначений',
    ],
  ),
  PatchRelease(
    build: 88,
    version: '1.0.1',
    items: [
      'Платформа: выключить/очистить/удалить студию, филиалы и логины (PIN владельца)',
    ],
  ),
  PatchRelease(
    build: 87,
    version: '1.0.1',
    items: [
      'Касса (мобилка): кнопки смены переносятся, кассы в 1–2 колонки без обрезки',
      'Сотрудники (мобилка): общий вертикальный скролл; роли свёрнуты по умолчанию',
    ],
  ),
  PatchRelease(
    build: 86,
    version: '1.0.1',
    items: [
      'Мобильная доска: скролл колонки без drag, кнопка смены статуса на карточке',
      'Мобильное меню: drawer целиком скроллится (пунты снова видны)',
    ],
  ),
  PatchRelease(
    build: 85,
    version: '1.0.1',
    items: [
      'Мобильное меню: drawer целиком скроллится, пункты «Доска / Заказ…» снова видны',
    ],
  ),
  PatchRelease(
    build: 84,
  ...
  PatchRelease(
    ...
    version: '1.0.1',
    items: [
      'Доступ: должности (Владелец/Управляющий/Админ/Мастер) и цеха раздельно',
      'Лампочка: филиал, должность, блок назначений; очистка БД — только владелец приложения + PIN',
    ],
  ),
  PatchRelease(
    build: 77,
    version: '1.0.1',
    items: [
      'Нет мастера на цех — не подставляем админа, уведомляем и оставляем «Назначить»',
    ],
  ),
  PatchRelease(
    build: 76,
    version: '1.0.1',
    items: [
      'Быстрая дата: перенесена под поиск в шапке бокового меню',
    ],
  ),
  PatchRelease(
    build: 75,
    version: '1.0.1',
    items: [
      'Календарь: поток одного цеха в заказе — одна карточка (без наложений)',
    ],
  ),
  PatchRelease(
    build: 74,
    version: '1.0.1',
    items: [
      'Календарь: в одном цехе не дробим работы заказа на окна, пока между ними нет чужого цеха',
    ],
  ),
  PatchRelease(
    build: 73,
    version: '1.0.1',
    items: [
      'Календарь «Детальное время»: колонки цехов на всю ширину экрана',
    ],
  ),
  PatchRelease(
    build: 72,
    version: '1.0.1',
    items: [
      'Защита от дублей: совпадение телефона, госномера или VIN — вопрос перед созданием',
      'Госномер: кириллица/латиница считаются одним номером (А/A, Х/X…)',
    ],
  ),
  PatchRelease(
    build: 42,
  ...
  PatchRelease(
    ...
    version: '1.0.1',
    items: [
      'Календарь: удерживайте карточку — перенос по времени (общая / неделя)',
    ],
  ),
  PatchRelease(
    build: 36,
